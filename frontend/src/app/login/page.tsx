...
import { Target, Lock, Mail, AlertTriangle, Loader2 } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleMouseMove = (e: MouseEvent<HTMLDivElement>) => {
    ...
    setTilt({ x: x * 0.03, y: y * 0.03 }); // Mild tilt

    // Calculate relative cursor position for radial glow (in percentage)
      ...
      <div className="w-full max-w-md z-10">
        ...
        >
          ...
          <p className="text-zinc-500 text-[10px] mt-2.5 uppercase font-bold tracking-widest">
            Sign in to your PrepIQ workspace
          </p>
        </motion.div>

        {/* Interactivity wrapper card */}
        <motion.div
